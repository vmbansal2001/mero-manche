    ...
    <section>
      <div className="lg:hidden mb-10">
        ...
        {post.shortDescription ? (
          <p className="mt-2 max-w-3xl text-base text-black/85">
            {post.shortDescription}
          </p>
        ) : null}
      </div>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm">
        <div className="relative w-full overflow-hidden bg-linear-to-br from-zinc-100 to-zinc-200">
          {post.coverImage ? (
            <div className="lg:p-1.5 border-2 border-zinc-200 rounded-3xl">
              <SanityImage
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white lg:block hidden">
            {dateLabel ? (
              <p className="text-sm font-medium uppercase tracking-wide">
                {dateLabel}
              </p>
