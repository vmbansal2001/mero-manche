...
const SheetModal: React.FC<SheetModalProps> = ({
  ...
  const modalContent = (
    <AnimatePresence>
      {open && (
        <div
          className="fixed inset-0 z-60 flex md:items-center items-end justify-center"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className={`relative w-full max-w-lg max-h-[90vh] md:rounded-b-xl rounded-t-xl overflow-auto no-scrollbar ${
              className?.container || ""
            }`}
